    ...
    <div class="SearchFilterAdd">
        ...
        <div class="container">
            ...
            <ul style="list-style-type: none; display: block;">
                <li class="testSearch" v-for="meal in filteredList()" :key="meal" @click="showWholeRecipe(meal.id)">

                    <span style="display: inline">{{ meal.meal }}</span>
                </li>
            </ul>
        </div>
